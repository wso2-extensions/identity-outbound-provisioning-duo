...
import org.wso2.carbon.identity.provisioning.duo.internal.DuoConnectorServiceComponent;
...
public class DuoConnectorServiceComponentTest {
    ...
    public void testActivate(boolean debugEnabled, boolean throwError) throws Exception {
        ...
        DuoConnectorServiceComponent component = new DuoConnectorServiceComponent();
        Whitebox.invokeMethod(component, "activate", componentContext);
